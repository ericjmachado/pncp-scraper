...
REGISTRO = {
    ...
    "orgaoEntidade": {"cnpj": "00000000000000", "razaoSocial": "ÓRGÃO TESTE", "esferaId": "M", "poderId": "E"},
    "unidadeOrgao": {"nomeUnidade": "UNIDADE", "municipioNome": "Goiânia", "ufSigla": "GO"},
    "modalidadeId": 6, "modalidadeNome": "Pregão - Eletrônico",
    "situacaoCompraNome": "Divulgada no PNCP", "srp": False,
    "valorTotalEstimado": 100000.0, "valorTotalHomologado": None,
    "dataPublicacaoPncp": "2026-01-01T00:00:00", "dataAberturaProposta": "2026-01-02T00:00:00",
    "dataEncerramentoProposta": "2099-01-01T00:00:00", "dataAtualizacaoGlobal": "2026-01-01T00:00:00",
...
for q in ("desenv gestao", 'aspas "duplas" OR', "goiania"):
    con.execute("SELECT COUNT(*) FROM editais_fts WHERE editais_fts MATCH ?",
                (perfil.fts_query_usuario(q),)).fetchone()
